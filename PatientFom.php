...
<body id="body1">
 ...
 <div id="formInput">
    <form action="http://localhost:8081/Shri/InsertPatientRecord.php" method="POST" onsubmit="return insert()">    
    ...
    <input type="radio" name="Gender" id="Female" id="Female" required><span class="span">Female</span><br><br><br>
    ...
    <input type="text" name="date" id="date2" value="today" hidden><br><br><br>
