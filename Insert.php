...
$date    = $_POST['date'];
  ...
  $query = mysqli_query($conn, $insert);
	...
	if($query)
	{
	echo"<style>#output{background-color:white; text-align:center;}</style><h1 style='color:green; padding-top:0px' >Inseted succesfully $query</h1>";
...
<?php
 if ($query!=1) {
    ...
    echo"<style>#output1{background-color:white; text-align:center;}</style><h1 style='color:red;'  id='errMsg'>As phone number or the patient record exists </h1>".mysqli_connect_error();
