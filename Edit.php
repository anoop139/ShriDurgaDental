...
<head>
    ...
    <link rel="stylesheet" href="StlyEdit.css?v=8">
...
//////echo"val in $name<br>";
$query ="Select *from patient where sno=$name";
...
<script>
   setTimeout(() => {
     document.getElementById("updateMessage").style.marginTop="-50px"
     console.log("hellp")
   }, 5000);
...
<td><a href="Edit/Name.html?v=<?php echo $show['sno'];?>">Edit name</a></td>
<td style="text-align:center;"><?php echo$show['age'];?></td>
<td style="text-align:center;"><a href="Edit/Age.html?v=<?php echo $show['sno'];?>">Edit age</a></td>
